...
public class ContractManagerDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Vendor>(builder =>
        {
            ...
            builder.HasIndex(v => v.Name).HasFilter("[IsDeleted] = 0");
        ...
        modelBuilder.Entity<Contract>(builder =>
        {
            ...
            builder.HasIndex(c => c.AssignedReviewerUserId);
            builder.HasIndex(c => c.Status);
            builder.HasIndex(c => c.TermEndDate);
            builder.HasIndex(c => c.NextActionDueAt);
            ...
            builder.HasOne(c => c.AssignedReviewer).WithMany()
                .HasForeignKey(c => c.AssignedReviewerUserId).OnDelete(DeleteBehavior.Restrict);
        });
        ...
        modelBuilder.Entity<ContractAssignment>(builder =>
        {
            ...
            builder.Property(a => a.ReviewerTeam).HasMaxLength(64).IsRequired();
            ConfigureAudit(builder);
